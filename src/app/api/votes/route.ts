...
export async function POST(request: NextRequest) {
    try {
        ...
        // response will try to fetch the vote document for that user
        ...
        // if the vote document already exists, i.e., user has already voted on that post and is voting again
